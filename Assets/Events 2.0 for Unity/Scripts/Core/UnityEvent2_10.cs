...
namespace UnityEngine.Events
{
	...
	public abstract class UnityEvent2<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : UnityEventBase2
	{
		...
		{
			return GetValidMethodInfo(targetObj, name, new System.Type[10] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7), typeof(T8), typeof(T9), typeof(T10) });
		}
