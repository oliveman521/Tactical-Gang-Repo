...
namespace UnityEngine.Events
{
	...
	class InvokableCall2<T1, T2> : BaseInvokableCall2
	{
		...
		public virtual void Invoke(T1 args0, T2 args1)
		{
			if (AllowInvoke(Delegate))
	...
	class InvokableCall2<T1, T2, T3> : BaseInvokableCall2
	{
		...
		public virtual void Invoke(T1 args0, T2 args1, T3 args2)
		{
			if (AllowInvoke(Delegate))
	...
	class InvokableCall2<T1, T2, T3, T4> : BaseInvokableCall2
	{
		...
		public virtual void Invoke(T1 args0, T2 args1, T3 args2, T4 args3)
		{
			if (AllowInvoke(Delegate))
	...
	class InvokableCall2<T1, T2, T3, T4, T5> : BaseInvokableCall2
	{
		...
		public virtual void Invoke(T1 args0, T2 args1, T3 args2, T4 args3, T5 args4)
		{
			if (AllowInvoke(Delegate))
	...
	class InvokableCall2<T1, T2, T3, T4, T5, T6> : BaseInvokableCall2
	{
		...
		public virtual void Invoke(T1 args0, T2 args1, T3 args2, T4 args3, T5 args4, T6 args5)
		{
			if (AllowInvoke(Delegate))
	...
	class InvokableCall2<T1, T2, T3, T4, T5, T6, T7> : BaseInvokableCall2
	{
		...
		public virtual void Invoke(T1 args0, T2 args1, T3 args2, T4 args3, T5 args4, T6 args5, T7 args6)
		{
			if (AllowInvoke(Delegate))
	...
	class InvokableCall2<T1, T2, T3, T4, T5, T6, T7, T8> : BaseInvokableCall2
	{
		...
		public virtual void Invoke(T1 args0, T2 args1, T3 args2, T4 args3, T5 args4, T6 args5, T7 args6, T8 args7)
		{
			if (AllowInvoke(Delegate))
	...
	class InvokableCall2<T1, T2, T3, T4, T5, T6, T7, T8, T9> : BaseInvokableCall2
	{
		...
		public virtual void Invoke(T1 args0, T2 args1, T3 args2, T4 args3, T5 args4, T6 args5, T7 args6, T8 args7, T9 args8)
		{
			if (AllowInvoke(Delegate))
	...
	class InvokableCall2<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : BaseInvokableCall2
	{
		...
		public virtual void Invoke(T1 args0, T2 args1, T3 args2, T4 args3, T5 args4, T6 args5, T7 args6, T8 args7, T9 args8, T10 args9)
		{
			if (AllowInvoke(Delegate))
	...
	class UpdatableInvokableCall<T1> : InvokableCall2<T1>
	{
		private readonly object[] m_Args = new object[1];

		private bool m_IsEventDefined = false;

		public UpdatableInvokableCall(Object target, MethodInfo theFunction, bool isEventDefined, T1 arg) : base(target, theFunction)
		{
			m_Args[0] = arg;
	...
	class UpdatableInvokableCall<T1, T2> : InvokableCall2<T1, T2>
	{
		...
		public override void Invoke(T1 args0, T2 args1)
		{
			if (m_IsEventDefined)
			{
				m_Args[0] = args0;
			...
			base.Invoke((T1)m_Args[0], (T2)m_Args[1]);
		}
	}
	...
	class UpdatableInvokableCall<T1, T2, T3> : InvokableCall2<T1, T2, T3>
	{
		...
		public override void Invoke(T1 args0, T2 args1, T3 args2)
		{
			if (m_IsEventDefined)
			{
				m_Args[0] = args0;
			...
			base.Invoke((T1)m_Args[0], (T2)m_Args[1], (T3)m_Args[2]);
		}
	}
	...
	class UpdatableInvokableCall<T1, T2, T3, T4> : InvokableCall2<T1, T2, T3, T4>
	{
		...
		public override void Invoke(T1 args0, T2 args1, T3 args2, T4 args3)
		{
			if (m_IsEventDefined)
			{
				m_Args[0] = args0;
			...
			base.Invoke((T1)m_Args[0], (T2)m_Args[1], (T3)m_Args[2], (T4)m_Args[3]);
		}
	}
	...
	class UpdatableInvokableCall<T1, T2, T3, T4, T5> : InvokableCall2<T1, T2, T3, T4, T5>
	{
		...
		public override void Invoke(T1 args0, T2 args1, T3 args2, T4 args3, T5 args4)
		{
			if (m_IsEventDefined)
			{
				m_Args[0] = args0;
			...
			base.Invoke((T1)m_Args[0], (T2)m_Args[1], (T3)m_Args[2], (T4)m_Args[3], (T5)m_Args[4]);
		}
	}
	...
	class UpdatableInvokableCall<T1, T2, T3, T4, T5, T6> : InvokableCall2<T1, T2, T3, T4, T5, T6>
	{
		...
		public override void Invoke(T1 args0, T2 args1, T3 args2, T4 args3, T5 args4, T6 args5)
		{
			if (m_IsEventDefined)
			{
				m_Args[0] = args0;
			...
			base.Invoke((T1)m_Args[0], (T2)m_Args[1], (T3)m_Args[2], (T4)m_Args[3], (T5)m_Args[4], (T6)m_Args[5]);
		}
	}
	...
	class UpdatableInvokableCall<T1, T2, T3, T4, T5, T6, T7> : InvokableCall2<T1, T2, T3, T4, T5, T6, T7>
	{
		...
		public override void Invoke(T1 args0, T2 args1, T3 args2, T4 args3, T5 args4, T6 args5, T7 args6)
		{
			if (m_IsEventDefined)
			{
				m_Args[0] = args0;
			...
			base.Invoke((T1)m_Args[0], (T2)m_Args[1], (T3)m_Args[2], (T4)m_Args[3], (T5)m_Args[4], (T6)m_Args[5], (T7)m_Args[6]);
		}
	}
	...
	class UpdatableInvokableCall<T1, T2, T3, T4, T5, T6, T7, T8> : InvokableCall2<T1, T2, T3, T4, T5, T6, T7, T8>
	{
		...
		public override void Invoke(T1 args0, T2 args1, T3 args2, T4 args3, T5 args4, T6 args5, T7 args6, T8 args7)
		{
			if (m_IsEventDefined)
			{
				m_Args[0] = args0;
			...
			base.Invoke((T1)m_Args[0], (T2)m_Args[1], (T3)m_Args[2], (T4)m_Args[3], (T5)m_Args[4], (T6)m_Args[5], (T7)m_Args[6], (T8)m_Args[7]);
		}
	}
	...
	class UpdatableInvokableCall<T1, T2, T3, T4, T5, T6, T7, T8, T9> : InvokableCall2<T1, T2, T3, T4, T5, T6, T7, T8, T9>
	{
		...
		public override void Invoke(T1 args0, T2 args1, T3 args2, T4 args3, T5 args4, T6 args5, T7 args6, T8 args7, T9 args8)
		{
			if (m_IsEventDefined)
			{
				m_Args[0] = args0;
			...
			base.Invoke((T1)m_Args[0], (T2)m_Args[1], (T3)m_Args[2], (T4)m_Args[3], (T5)m_Args[4], (T6)m_Args[5], (T7)m_Args[6], (T8)m_Args[7], (T9)m_Args[8]);
		}
	}
	...
	class UpdatableInvokableCall<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : InvokableCall2<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
	{
		...
		public override void Invoke(T1 args0, T2 args1, T3 args2, T4 args3, T5 args4, T6 args5, T7 args6, T8 args7, T9 args8, T10 args9)
		{
			if (m_IsEventDefined)
			{
				m_Args[0] = args0;
			...
			base.Invoke((T1)m_Args[0], (T2)m_Args[1], (T3)m_Args[2], (T4)m_Args[3], (T5)m_Args[4], (T6)m_Args[5], (T7)m_Args[6], (T8)m_Args[7], (T9)m_Args[8], (T10)m_Args[9]);
		}
	}
	...
	class PersistentCall2
	{
		...
		private static BaseInvokableCall2 GetObjectCall(Object target, MethodInfo method, ArgumentCache2 argument)
		{
			...
			if (!string.IsNullOrEmpty(argument.unityObjectArgumentAssemblyTypeName))
				type = System.Type.GetType(argument.unityObjectArgumentAssemblyTypeName, false) ?? typeof(Object);
			ConstructorInfo constructor = typeof(UpdatableInvokableCall<>).MakeGenericType(type).GetConstructor(new System.Type[4] { typeof(Object), typeof(MethodInfo), typeof(bool), type });
			Object @object = argument.unityObjectArgument;
			if (@object != null && !type.IsAssignableFrom(@object.GetType()))
				@object = null;
			return constructor.Invoke(new object[4] { target, method, false, @object }) as BaseInvokableCall2;
		}
		...
		{
			System.Type[] typeArguments = new System.Type[arguments.Length];
			System.Type[] types = new System.Type[arguments.Length + 3];
			...
			{
				typeArguments[i] = System.Type.GetType(arguments[i].unityObjectArgumentAssemblyTypeName, false) ?? typeof(Object);
			...
			System.Type invokableType = typeof(InvokableCall2);
		...
		private static object GetValue(System.Type type, ArgumentCache2 argument)
		{
...
#pragma warning restore 414
		...
		{
			System.Type[] argumentTypes = new System.Type[call.arguments.Count];

			for (int i = 0; i < argumentTypes.Length; i++)
				argumentTypes[i] = System.Type.GetType(call.arguments[i].unityObjectArgumentAssemblyTypeName, false) ?? typeof(Object);

			return GetValidMethodInfo(call.target, call.methodName, argumentTypes);
		}

		internal MethodInfo FindMethod(object listener, string name, PersistentListenerMode2 mode, System.Type argumentType)
		{
			switch (mode)
			{
				...
				case PersistentListenerMode2.Object:
					return GetValidMethodInfo(listener, name, new System.Type[1] { argumentType ?? typeof(Object) });
				case PersistentListenerMode2.Int:
					return GetValidMethodInfo(listener, name, new System.Type[1] { typeof(int) });
				case PersistentListenerMode2.Float:
					return GetValidMethodInfo(listener, name, new System.Type[1] { typeof(float) });
				case PersistentListenerMode2.String:
					return GetValidMethodInfo(listener, name, new System.Type[1] { typeof(string) });
				case PersistentListenerMode2.Bool:
					return GetValidMethodInfo(listener, name, new System.Type[1] { typeof(bool) });
				case PersistentListenerMode2.Enum:
					return GetValidMethodInfo(listener, name, new System.Type[1] { typeof(Enum) });
				default:
					return null;
			}
		}

		public MethodInfo FindMethod(object listener, string name, PersistentListenerMode2 mode, System.Type[] argumentTypes = null)
		{
		...
		protected bool ValidateRegistration(MethodInfo method, object targetObj, PersistentListenerMode2 mode, System.Type argumentType)
		{
			if (method == null)
